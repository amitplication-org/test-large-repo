...
@InputType()
class LuUsersUsertypeCreateNestedManyWithoutUserModelsInput {
...
export { LuUsersUsertypeCreateNestedManyWithoutUserModelsInput as LuUsersUsertypeCreateNestedManyWithoutUserModelsInput };
